            ...
            <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white px-8 py-12">
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                        <div>
                            ...
                            <p className="text-xl text-blue-100 mb-4">{t("title")}</p>
                ...
                <div className="px-8 py-8">
                    ...
                    <section className="mb-10">
                        ...
                        <div className="space-y-6">
                            {t.raw("projectsList").map((project: any, index: number) => (
                    ...
                    <section className="mb-10">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            {t.raw("skillCategories").map((category: any, index: number) => (
                                <div key={index} className="bg-gray-50 p-6 rounded-lg">
                        ...
                        <div className="space-y-6">
                            {t.raw("educationList").map((edu: any, index: number) => (
                                <div key={index} className="border-l-4 border-blue-200 pl-6">
                                    ...
                                    <p className="text-gray-600 font-medium">{edu.extras}</p>
