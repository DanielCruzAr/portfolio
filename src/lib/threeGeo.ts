...
export function drawThreeGeo({ json, radius, materialOptions }: DrawThreeGeoParams): THREE.Object3D {
  ...
  function createCoordinateArray(feature: [number, number][]): [number, number][] {
  ...
  function needsInterpolation(point2: [number, number], point1: [number, number]): boolean {
  ...
  function interpolatePoints(interpolation_array: [number, number][]): [number, number][] {
  ...
  function getMidpoint(point1: [number, number], point2: [number, number]): [number, number] {
  ...
  function convertToSphereCoords(coordinates_array: [number, number], sphere_radius: number): void {
  ...
  function drawLine(x_values: number[], y_values: number[], z_values: number[], options: THREE.PointsMaterialParameters): void {
